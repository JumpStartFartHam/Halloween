...
import net.mcreator.halloween.procedures.BloodFoodEatenProcedure;
...
public class BloodItem extends HalloweenModElements.ModElement {
	@ObjectHolder("halloween:blood")
	public static final Item block = null;
	public BloodItem(HalloweenModElements instance) {
		super(instance, 37);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemStack, World world, LivingEntity entity) {
			...
			double z = entity.getPosZ();
			{
				...
				BloodFoodEatenProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
