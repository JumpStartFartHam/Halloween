...
import net.mcreator.halloween.procedures.ScarecrowOnEntityTickUpdateProcedure;
...
public class ScarecrowEntity extends HalloweenModElements.ModElement {
	public static EntityType entity = null;
	public ScarecrowEntity(HalloweenModElements instance) {
		super(instance, 2);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 3f)).build("scarecrow")
						.setRegistryName("scarecrow");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("scarecrow"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new Modelscarecrow(), 0.5f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("halloween:textures/scarecrow.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Blocks.HAY_BLOCK, (int) (1)));
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				ScarecrowOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
